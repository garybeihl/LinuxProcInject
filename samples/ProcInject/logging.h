...
typedef enum _INJECT_ERROR_CODE {
    ...
    INJECT_ERROR_STACK_INDEX_OUT_OF_RANGE = 0xF002,
    INJECT_ERROR_ADDRESS_OUT_OF_RANGE = 0xF003,
    INJECT_ERROR_POINTER_OVERFLOW = 0xF004,
    INJECT_ERROR_MEMORY_NOT_WRITABLE = 0xF005,
